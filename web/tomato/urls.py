...
urlpatterns = patterns('',
    ...
    url(r'^security/$', 'tomato.security.list', {"tech": None},name='security_list'),
    url(r'^security/bytech/(?P<tech>\w+)$', 'tomato.security.list', name="security_list_bytech"),
    (r'^security/add$', 'tomato.security.add'),
    (r'^security/add/(?P<tech>\w+)$', 'tomato.security.add'),
    (r'^security/(?P<res_id>\w{24})$', 'tomato.security.info'),
